...
public class FolderVideoList23rdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_folder_video_list_23rd);
    ...
    public void clickViews() {
        ...
        videosAdapter = new Videos23rdAdapter(videoInformationArrayList, FolderVideoList23rdActivity.this);
        rvVideoList.setLayoutManager(new LinearLayoutManager(FolderVideoList23rdActivity.this, LinearLayoutManager.VERTICAL, false));
        ...
        ivSearch.setOnClickListener(v -> {
            Intent intent = new Intent(FolderVideoList23rdActivity.this, SearchVideo23rdActivity.class);
        ...
        ivGrid.setOnClickListener(v -> {
            ...
            if (isGrid) {
                ivGrid.setImageDrawable(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.ic_list_23rd));
            } else {
                ivGrid.setImageDrawable(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.ic_grid_23rd));
            }
            setLayoutManager();
        });
    ...
    private void sortBottomSheet() {
        ...
        if (selectedSortType.isEmpty()) {
            ...
            tvNewToOldDate.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.ic_install_bg_23rd));
            tvOldToNewDate.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.stoke_bg_23rd));
            tvNameAtoZ.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.stoke_bg_23rd));
            tvNameZtoA.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.stoke_bg_23rd));
            tvSmallToBigSize.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.stoke_bg_23rd));
            tvBigToSmallSize.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.stoke_bg_23rd));
            ...
            tvNewToOldDate.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.stoke_bg_23rd));
            tvOldToNewDate.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.ic_install_bg_23rd));
            tvNameAtoZ.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.stoke_bg_23rd));
            tvNameZtoA.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.stoke_bg_23rd));
            tvSmallToBigSize.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.stoke_bg_23rd));
            tvBigToSmallSize.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.stoke_bg_23rd));
            ...
            tvNewToOldDate.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.stoke_bg_23rd));
            tvOldToNewDate.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.stoke_bg_23rd));
            tvNameAtoZ.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.ic_install_bg_23rd));
            tvNameZtoA.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.stoke_bg_23rd));
            tvSmallToBigSize.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.stoke_bg_23rd));
            tvBigToSmallSize.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.stoke_bg_23rd));
            ...
            tvOldToNewDate.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.stoke_bg_23rd));
            tvNameAtoZ.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.stoke_bg_23rd));
            tvNameZtoA.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.ic_install_bg_23rd));
            tvSmallToBigSize.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.stoke_bg_23rd));
            tvBigToSmallSize.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.stoke_bg_23rd));
            ...
            tvNameAtoZ.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.stoke_bg_23rd));
            tvNameZtoA.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.stoke_bg_23rd));
            tvSmallToBigSize.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.ic_install_bg_23rd));
            tvBigToSmallSize.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.stoke_bg_23rd));
            ...
            tvNameZtoA.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.stoke_bg_23rd));
            tvSmallToBigSize.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.stoke_bg_23rd));
            tvBigToSmallSize.setBackground(ContextCompat.getDrawable(FolderVideoList23rdActivity.this, R.drawable.ic_install_bg_23rd));
        }
        ...
        if (shouldExecuteOnResume) {
            if (prefManagerVideo22nd.getString("extrascreennative").contains("1")) {
                ...
                if ((flSmallSizeNative != null) && (flSmallSizeNative.getChildCount() == 0)) {
                    adController23rd.newreleasenativePreloadExtra(FolderVideoList23rdActivity.this, prefManagerVideo22nd.getString(TAG_NATIVEIDD), 2, flSmallSizeNative, true);
                }
            }
...
//            shouldExecuteOnResume = true;
    ...
    public void onBackPressed() {
        adController23rd.showInterAdCallBack(FolderVideoList23rdActivity.this, this::superOnBackPressed);
    }
    ...
    public void loadData() {
        FetchStorageVideo23rd.showLoader(FolderVideoList23rdActivity.this);
        ExecutorService executorService = Executors.newSingleThreadExecutor();

        executorService.execute(new Runnable() {
            @Override
            public void run() {
                ArrayList<GalleryVideoInformation23rd> videoFolders = FetchStorageVideo23rd.getGalleryVideosFromFolder(FolderVideoList23rdActivity.this, folderPath);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Videos23rdAdapter.DELETE_REQUEST_CODE) {
            if (resultCode != 0) {
                ...
                videosAdapter.notifyDataSetChanged();
                Toast.makeText(FolderVideoList23rdActivity.this, "Video Deleted successfully", Toast.LENGTH_SHORT).show();
            }
        }
    }
}