...
public class Fifth23rdActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_23rd_screen_five);
        AdsManager23rd.showAndLoadNativeAd(this, findViewById(R.id.nativeAd), 3);
        onClicks();
    }
    ...
    private void startActivity() {
        ...
        if (new PrefManagerVideo23rd(this).getString(Splash23rdActivity.status_dummy_six_enabled).contains("true")) {
