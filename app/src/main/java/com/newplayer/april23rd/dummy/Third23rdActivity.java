...
public class Third23rdActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_23rd_screen_three);
    ...
    private void startActivity() {
        Intent intent;
        if (new PrefManagerVideo23rd(Third23rdActivity.this).getString(Splash23rdActivity.status_dummy_four_enabled).contains("true")) {
            intent = new Intent(Third23rdActivity.this, Fourth23rdActivity.class);
        } else if (new PrefManagerVideo23rd(this).getString(Splash23rdActivity.status_dummy_five_enabled).contains("true") && !new PrefManagerVideo23rd(Third23rdActivity.this).getString(Splash23rdActivity.TAG_NATIVEID).contains("sandeep")) {
            ...
            intent = new Intent(Third23rdActivity.this, Main23rdActivity.class);
        }
    ...
    public void onBackPressed() {
        Intent intent;
        if (new PrefManagerVideo23rd(this).getString(Splash23rdActivity.status_dummy_two_back_enabled).contains("true")) {
